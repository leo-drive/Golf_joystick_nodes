...
class State(metaclass=Metaclass_State):
    ...
    def nunchuk_joystick_zeroed(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'nunchuk_joystick_zeroed' field must be a set or sequence with length 2 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(val >= -3.402823e+38 and val <= 3.402823e+38 for val in value)), \
                "The 'nunchuk_joystick_raw' field must be a set or sequence with length 2 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
    ...
    def raw_battery(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'raw_battery' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def percent_battery(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'percent_battery' field must be a float in [-3.402823e+38, 3.402823e+38]"
